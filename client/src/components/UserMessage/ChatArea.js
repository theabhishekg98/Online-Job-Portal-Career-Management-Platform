    ...
    render() {
        return (
            ...
            {this.state.messages.length==0?<Paper style={{height:"100%"}}>
                <Typography justifyContent="center" alignContent="center">Click on Chats to view chats</Typography>
            </Paper>
                ...
                <TableBody>
                   ...
                   { this.state.messages.map(chat=>{
                        return <React.Fragment>
                            {chat.from=="user"?<div style={{justifyContent:"flex-end" ,display:"flex"}}>
